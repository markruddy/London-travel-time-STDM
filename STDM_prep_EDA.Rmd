...
d <- as.Date(index(ujt.ts), format="%d-%b-%Y")
...
# clean up
rm(obstime, intervals, a, d, ujt.date, intervals.d, dayseq)
```
...
p + geom_line() + 
  ...
  labs(title="Average unit jounrey time profiles", x="Time of day (hour)", y="Mean unit journey time (seconds/metre)")
